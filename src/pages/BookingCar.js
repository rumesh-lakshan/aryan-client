...
function BookingCar({ match }) {
  ...
  useEffect(() => {
    let amount = totalDays * car.rentPerHour;
    if (driver) {
      amount += totalDays * 5000; // Assuming the driver cost is per day
    }
        ...
        <Col lg={10} sm={24} xs={24} className="text-right">
          <div style={{ width: "60%", margin: "auto" }}>
            ...
            >
              ...
              <p>
                <strong>Vehicle Rent Per Day: </strong>
                {car.rentPerHour} LKR
              </p>
              <p>
            ...
            >
              ...
              {timeSlots.length <= 0 ? (
                ...
                <div>
                  {timeSlots.map((slot) => (
                    <div className="mt-4" key={slot._id}>
                      <p>
                        <strong>From: </strong>
            ...
            {from && to && (
              <div>
                ...
                <p>
                  Rent Per Day: <b>{car.rentPerHour} LKR</b>
                </p>
                <Checkbox
